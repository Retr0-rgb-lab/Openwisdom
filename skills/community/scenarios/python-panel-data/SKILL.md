...
description: "Panel FE/RE and DiD in Python via linearmodels with clustering."
layer: scenario
scope: community
disciplines: ["economics"]
language: "en"
tags: ["python", "panel-data", "fixed-effects", "did", "curated-external", "openwisdom"]
version: "0.1.0"
license: "CC0-1.0"
metadata:
  openwisdom: true
  provenance: "curated-external"
  upstream: "https://github.com/meleantonio/awesome-econ-ai-stuff/tree/main/_skills/analysis/python-panel-data"
---
# Python Panel Data

## Summary

Panel FE/RE and DiD in Python via linearmodels with clustering.
