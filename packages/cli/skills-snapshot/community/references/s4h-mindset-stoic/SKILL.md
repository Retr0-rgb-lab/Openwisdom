---
name: s4h-mindset-stoic
description: "Practical Stoic toolkit: dichotomy of control, premeditatio, amor fati, memento mori."
layer: reference
scope: community
disciplines: ["philosophy", "psychology"]
language: "en"
tags: ["stoicism", "ethics", "mindset", "curated-external", "openwisdom"]
version: "0.1.0"
license: "MIT"
metadata:
  openwisdom: true
  provenance: "curated-external"
  upstream: "https://github.com/human-avatar/skills-for-humanity/tree/main/skills/s4h-mindset-stoic"
---
# Stoic Mindset Toolkit

## Summary

Practical Stoic toolkit: dichotomy of control, premeditatio, amor fati, memento mori.
