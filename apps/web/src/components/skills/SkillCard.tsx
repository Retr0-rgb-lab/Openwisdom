...
function isLinkOnlyEntry(entry: CatalogEntry): boolean {
  return (
          ...
          <div className="flex min-w-0 flex-col gap-1.5">
            ...
            <h3 className="flex items-start gap-2 font-serif text-[1.2rem] leading-[1.2] font-semibold tracking-[-0.02em] text-ink md:text-[1.3rem]">
              ...
              <Link
                ...
                className="min-w-0 rounded-sm outline-none hover:text-primary focus-visible:text-primary focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2"
              >
                {title}
              </Link>
            </h3>
